  ...
  return (
    <div className="max-w-[1640px] m-auto px-4 py-12">
      ...
      <div className="flex flex-col lg:flex-row justify-between"> 
        {/* Filter Type */}
        <div>
            <p className="font-bold text-gray-700">Price Type</p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
        {foods.map((item, index) => (
            <div key = {index} className="border shadow-xl hover:scale-105 rounded-lg duration-300">
                <img className="w-full h-[200px] object-cover rounded-t-lg cursor-pointer" src={item.image} alt="{item.name}"/>
